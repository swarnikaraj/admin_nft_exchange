...
const createCollection = async (req, res, next) => {
  ...
  if (Object.keys(Openseacollection).length > 0) {
    ...
    let obj = {
      ...
      name: alchemyContract.contractMetadata.name || target_data.collection.primary_asset_contracts.name,
      symbol: alchemyContract.contractMetadata.symbol || target_data.collection.primary_asset_contracts.symbol,
      ...
      instagramLink:"https://www.instagram.com/"+target_data.collection.instagram_username,
      mediumLink:"https://medium.com/"+target_data.collection.medium_username,
      discordLink:target_data.collection.discord_url,
      instagramLink:target_data.collection.telegram_url,
      twitterLink:"https://twitter.com/"+target_data.collection.twitter_username,
      logo:formatedLogo,
      imageURL: target_data.collection.image_url,
      owner:formatedOwner,
      countOwners:target_data.collection.primary_asset_contracts.owner || target_data.collection.stats.num_owners,
      ...
      totalSuppply: alchemyContract.contractMetadata.totalSupply || target_data.collection.stats.total_supply,
